...
BASE_VAULT_VERSION=1.14.3

# Install Go
wget https://golang.org/dl/go1.20.7.linux-amd64.tar.gz # https://go.dev/doc/install
rm -rf /usr/local/go && tar -C /usr/local -xzf go1.20.7.linux-amd64.tar.gz # https://go.dev/doc/install
export GOPATH=~/go
